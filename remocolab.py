#@title # RUN SETUP { vertical-output: true, display-mode: "form" }

VNC_MODE = True #@param {type:"boolean"}
#@markdown ##### **NOTE:Use "apt_update" if setup fails**
apt_update = False #@param {type:"boolean"} 
ignore_gpu_check = True #@param {type:"boolean"}
root_password = "root" #@param {type:"string"}
user_name = "colab" #@param {type:"string"}
user_password = "colab" #@param {type:"string"}
ngrok_token = "copy from here http://dashboard.ngrok.com/auth" #@param {type:"string"}
ngrok_region = "in" #@param ["us", "eu", "ap","au","sa","in","jp"]
vnc_passwd = "colab" #@param {type:"string"}
browser = "firefox" #@param ["chrome","firefox"]

import apt, apt.debfile ,os
import requests
...
""")
  ...
  # vnc_passwd = "rayanfer32" #@param {type:"string"}
  gpu_name = _get_gpu_name()
  if gpu_name != None:
    _setup_nvidia_gl()
...
def setupVNC(ngrok_region = ngrok_region):
